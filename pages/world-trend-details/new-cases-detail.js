...
export default function NewCasesDetailPage() {
  return (
    <>
      <Head>
        <title>Covid New Cases Details</title>
        <meta httpEquiv="content-language" content="en-gb" />

        <meta name="description" content="" />

        <meta property="og:title" content="Covid New Cases Details" />
        <meta
          property="og:description"
          content="The Covid New Cases Details page provides information on the number of people who have been infected by Covid. The data is sourced from BNO News and includes information on the country, year, and cause of death."
        />
